...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Welcome to pizza dom! what can i get for you?';
...
const OrderPizzaIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'sounds delicious! your order of a ' + size + ' ' + crust + ' crust pizza with ' + topping + ' should arrive in 30 minutes!';
